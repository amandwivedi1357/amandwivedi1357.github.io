      ...
      <Flex>
        ...
        <div className='right'>
            <div className='right-cont'>
                    ...
                    <Text className='desc'>Full Stack Web Developer with specialization in frontend and backend developemnet.Adaptable to new technologies to enhance my skills and capabilities.</Text>
